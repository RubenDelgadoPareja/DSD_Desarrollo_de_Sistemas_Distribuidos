		...
		try{
			...
			switch(args[1]) {
				...
				case "registra":
					...
					System.out.println("CS1 Registro: "+args[2]);
				...
				case "dona":
					...
					System.out.println("CS1 Dona: "+args[2]);
				...
				case "totaldonado":
					...
					System.out.println("CS1 Totaldonado: "+args[2]);
				...
				default:
					...
					System.out.println("Operación no permitida: "+args[1]);
					break;

			}
		
		} catch (Exception e) {
			System.err.println("CS1 Excepción:");
			e.printStackTrace();
		}
	}
}
